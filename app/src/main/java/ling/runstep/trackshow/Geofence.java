...
public class Geofence implements OnClickListener {
    ...
    protected static void addEntity() {
        // entity标识
        String entityName = StartSportActivity.entityName;
        // 属性名称（格式 : "key1=value1,columnKey2=columnValue2......."）
        String columnKey = "";
        StartSportActivity.client.addEntity(StartSportActivity.serviceId, entityName, columnKey, StartSportActivity.entityListener);
    }
    ...
    private void createFence() {
        ...
        // 创建者（entity标识）
        String creator = StartSportActivity.entityName;
        // 围栏名称
        String fenceName = StartSportActivity.entityName + "_fence";
        // 围栏描述
        String fenceDesc = "test";
        // 监控对象列表（多个entityName，以英文逗号"," 分割）
        String monitoredPersons = StartSportActivity.entityName;
        // 观察者列表（多个entityName，以英文逗号"," 分割）
        String observers = StartSportActivity.entityName;
        // 生效时间列表
        ...
        StartSportActivity.client.createCircularFence(StartSportActivity.serviceId, creator, fenceName, fenceDesc,
    ...
    private static void deleteFence(int fenceId) {
        StartSportActivity.client.deleteFence(StartSportActivity.serviceId, fenceId, geoFenceListener);
    }
    ...
    private void updateFence() {
        ...
        StartSportActivity.client.updateCircularFence(StartSportActivity.serviceId, fenceName, fenceId, fenceDesc,
                monitoredPersons,
    ...
    private void queryFenceList() {
        ...
        // 围栏ID列表
        String fenceIds = "";
        StartSportActivity.client.queryFenceList(StartSportActivity.serviceId, creator, fenceIds, geoFenceListener);
    }
    ...
    private void monitoredStatus() {
        ...
        // 监控对象列表（多个entityName，以英文逗号"," 分割）
        String monitoredPersons = StartSportActivity.entityName;
        StartSportActivity.client.queryMonitoredStatus(StartSportActivity.serviceId, fenceId, monitoredPersons,
                geoFenceListener);
    }
    ...
    private void historyAlarm() {
        ...
        StartSportActivity.client.queryFenceHistoryAlarmInfo(StartSportActivity.serviceId, fenceId, monitoredPersons, beginTime,
                endTime,
                geoFenceListener);
    }
    ...
    private void delayAlarm() {
        ...
        int fenceId = Geofence.fenceId;
        // 观察者列表（多个entityName，以英文逗号"," 分割）
        String observer = StartSportActivity.entityName;
        // 延迟时间（unix时间戳）
        int delayTime = (int) (System.currentTimeMillis() / 1000 + this.delayTime * 60);
        StartSportActivity.client.delayFenceAlarm(StartSportActivity.serviceId, fenceId, observer, delayTime,
                geoFenceListener);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_setFence:
                inputDialog();
                StartSportActivity.mBaiduMap.setOnMapClickListener(mapClickListener);
                popupwindow.dismiss();
                break;
        ...
        builder.setTitle("围栏半径(单位:米)").setView(circleRadius)
                .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // TODO Auto-generated method stub
                        StartSportActivity.mBaiduMap.setOnMapClickListener(null);
                    }
