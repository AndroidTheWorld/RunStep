package ling.runstep.trackutils;
...
@ContentView(R.layout.date_select_wheel)
...
//        btnSure.setOnClickListener(this);
        ...
        LayoutParams paramsHours = new LayoutParams(width, height / 3 + 10);
        dateLayout.setLayoutParams(paramsHours);
