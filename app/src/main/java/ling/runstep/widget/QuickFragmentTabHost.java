 ...
 * complete}
 */
public class QuickFragmentTabHost extends TabHost
    ...
    public QuickFragmentTabHost(Context context) {
    ...
    public QuickFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
